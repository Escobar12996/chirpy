...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter  {
    ...
    protected void configure(HttpSecurity http) throws Exception {
            ...
            http.authorizeRequests().antMatchers("/resendemail", "/regitrationConfirm", "/userimages", "/userdetails", "/explorer/{hashtag}", "/register", "/css/**", "/js/**", "/", "/explorer", "/image/{tipo}/{id}", "/viewpublication/{id}").permitAll()
                ...
                .antMatchers("/administration", "/administration/users", "/administration/userimages/{id}", "/administration/userpublications/{id}", "/administration/userpost/{id}", "/administration/deleteimage", "/administration/deletepost", "/administration/posts", "/administration/images").hasAuthority("admin")
                .and()
